<template>
    ...
    >
      ...
      <el-form-item label="默认物流 zc_logistics.id" prop="logisticId">
        <el-select
          ...
          placeholder="请选择默认物流 zc_logistics.id"
          clearable
          class="!w-240px"
        >
          <el-option label="请选择字典生成" value="" />
      ...
      <el-form-item label="关联品牌 zc_brand.id" prop="brandId">
        <el-select
          ...
          placeholder="请选择关联品牌 zc_brand.id"
          clearable
          class="!w-240px"
        >
          <el-option label="请选择字典生成" value="" />
      ...
      <el-form-item label="当前账户余额（业务变更必须同步写入 zc_customer_balance_log）" prop="balance">
        <el-input
          ...
          placeholder="请输入当前账户余额（业务变更必须同步写入 zc_customer_balance_log）"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
  ...
  <ContentWrap>
    ...
    <el-table-column type="selection" width="55" />
      ...
      <el-table-column label="县区" align="center" prop="district" />
      ...
      <el-table-column label="默认物流 zc_logistics.id" align="center" prop="logisticId" />
      <el-table-column label="关联品牌 zc_brand.id" align="center" prop="brandId" />
      <el-table-column label="当前账户余额（业务变更必须同步写入 zc_customer_balance_log）" align="center" prop="balance" />
