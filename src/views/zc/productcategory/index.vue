    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['zc:product-category:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['zc:product-category:export']"
        >
        ...
        <el-button
            ...
            v-hasPermi="['zc:product-category:delete']"
        >
      ...
      <el-table-column label="操作" align="center" min-width="120px">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['zc:product-category:update']"
          >
            编辑
          </el-button>
          <el-button
...
import { ProductCategoryApi, ProductCategory } from '@/api/zc/productcategory'
...
const handleRowCheckboxChange = (records: ProductCategory[]) => {
