    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['zc:curtain-structure-element:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['zc:curtain-structure-element:export']"
        >
      ...
      <el-table-column label="操作" align="center" min-width="120px">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['zc:curtain-structure-element:update']"
          >
            编辑
          </el-button>
          <el-button
...
/** 窗帘结构组件 列表 */
defineOptions({ name: 'ZcCurtainStructureElement' })
...
const getList = async () => {
  loading.value = true
  try {
    const data = await CurtainStructureElementApi.getCurtainStructureElementPage(queryParams)
...
const handleDelete = async (id: number) => {
  try {
    ...
    // 发起删除
    await CurtainStructureElementApi.deleteCurtainStructureElement(id)
...
const handleExport = async () => {
  try {
    ...
    const data = await CurtainStructureElementApi.exportCurtainStructureElement(queryParams)
    download.excel(data, '窗帘结构组件.xls')
  } catch {
  } finally {
