<template>
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      ...
      <el-form-item label="封面图片地址" prop="picUrl">
      ...
      <el-form-item label="是否热门(小程序)" prop="recommendHot">
      ...
      <el-form-item label="是否轮播图(小程序)" prop="recommendBanner">
...
import { ProjectApi, Project } from '@/api/quiz/project'
...
const formRules = reactive({
  ...
  picUrl: [{ required: true, message: '封面图片地址不能为空', trigger: 'blur' }],
...
const submitForm = async () => {
  ...
  formLoading.value = true
  try {
    const data = formData.value as unknown as Project
